...
SEPARATOR = {'drug':'\t','kegg':'\t','ogb':' '}
THRESHOLD = {'drug':4,'kegg':4,'ogb':4} #添加drug修改
NEIGHBOR_SIZE = {'drug':4,'kegg':4,'ogb':4}
...
PERFORMANCE_LOG = 'KGCN_performance'
...
class ModelConfig(object):
    def __init__(self):
        ...
        self.n_depth = 1    # depth of receptive field
